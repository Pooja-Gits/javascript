...
books.sort((b1, b2) => b2.pageCount - b1.pageCount);
//books.slice(0, 10).forEach(b => {
//    console.log(b.title, b.pageCount);
//});

books
    .sort((b1, b2) => b1 - b2)
    .filter(b => b.longDescription !== undefined && b.longDescription.toLowerCase().includes("c#"))
    .slice(1, 10)
    .forEach(b => console.log(b.title, b.pageCount));