...
const publishedBooks = books.filter(b => b.status === "PUBLISH");
console.log(publishedBooks);

const microsoftPublished = books.filter(b => b.status === "PUBLISH" && b.categories.includes("Microsoft"));
console.log(microsoftPublished);

const csharpBooks = books.filter(b => (
    (b.longDescription !== undefined) &&
    (b.longDescription.toUpperCase().indexOf("C#") > 0 ||
        b.longDescription.toUpperCase().indexOf("CSHARP") > 0)
));

csharpBooks.forEach(b => console.log(b.title));
...
booksFiltered.forEach(b => console.log(b.title));
